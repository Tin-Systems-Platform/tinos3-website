  ...
  return (
    <div className="absolute inset-x-0 top-0 flex bg-zinc-800">
        ...
        <div id="header-buttons" className="absolute top-0 right-0 flex pr-4 pt-4 bg-zinc-800">
          ...
          <Link href="/news">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 rounded ml-3 w-20">
                News
            </button>
          </Link>

          <Link rel="stylesheet" href="/stats" >
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 rounded ml-3 w-20">
                Stats
            </button>
          </Link>

          <Link rel="stylesheet" href="/issues" >
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 rounded ml-3 w-20">
                Issues
            </button>
          </Link>          
